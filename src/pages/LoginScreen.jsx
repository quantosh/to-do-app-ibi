...
function Loginscreen () {
  ...
  const style = {
    mainContainer:
      'flex p-8 w-full h-full items-center justify-center content-center center ',
    loginContainer: ''
  }
        ...
        <div>
          <div className={style.loginContainer}>
              ...
              <div>
                <form className=''>
                  ...
                  <div className='items-center justify-between'>
                    <button
                      className='text-sm w-full bg-yellow-400 hover:bg-yellow-400/90 py-2 rounded focus:outline-none focus:shadow-outline'
            ...
            <div className='flex justify-between mt-4 text-sm'>
              <a
                className='text-white shadow hover:text-yellow-400 drop-shadow-md'
                href='#'
              >
                Sign up
              </a>
              <a
                className='text-white shadow hover:text-yellow-400 drop-shadow-xl'
                href='#'
              >
                Forgot Password?
              </a>
