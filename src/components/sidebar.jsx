    ...
    <div>
      <div className={style.sidebar}>
        ...
        <aside
          ...
          class="block top-0 left-0 z-40 w-64 transition-transform -translate-x-full sm:translate-x-0"
          aria-label="Sidebar"
        >
          <div class="h-full px-3">
            <a href="" class="flex items-center mb-4 justify-center">
              <img
                ...
                alt="Flowbite Logo"
              />
              <span class="self-center text-l font-semibold whitespace-nowrap">
                To Do App
              </span>
            </a>
            <ul class="space-y-2">
              ...
              <li>
                ...
                >
                  ...
                  <span class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-black bg-white rounded-full">
                    12
                  </span>
                </a>
              </li>
            ...
            <div
              id="dropdown-cta"
              class="p-4 mt-6 rounded-lg backdrop-blur-sm bg-yellow-400 border border-white/40 rounded-xl shadow-xl"
              role="alert"
            >
              <div class="flex items-center mb-3">
                <span class="bg-white text-black text-sm font-semibold mr-2 px-2.5 py-0.5 rounded">
                  Beta
                </span>
                <button
                  type="button"
                  class="ml-auto -mx-1.5 -my-1.5 rounded-lg focus:ring-2 focus:ring-blue-400 p-1 hover:bg-blue-200 inline-flex h-6 w-6"
              ...
              <p class="mb-3 text-sm">
                Preview the beta of my task manager! You can use all the basic
                crud operations and the new color chooser! ❤
              </p>
              <a
                class="text-sm underline hover:text-yellow-500"
